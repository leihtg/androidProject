 ...
 */
public class MoneyInRecordAdapter extends BaseAdapter {

    Context context;
    ArrayList<MoneyInModel_out> array;

    public MoneyInRecordAdapter(Context context, ArrayList<MoneyInModel_out> array) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.listitem_money_in, parent, false);
        }

        MoneyInModel_out item = array.get(position);
        ...
        tv_bankName.setText(String.valueOf(item.getBankName()));
     ...
     * @param array
     */
    public void refresh(ArrayList<MoneyInModel_out> array) {
        this.array = array;
